...
parser.add_argument('--dataset', default='Cell_Phones_and_Accessories', help='dataset name: AMAZON_FASHION/Cell_Phones_and_Accessories/Grocery_and_Gourmet_Food/Sports_and_Outdoors/Instacart/sample')
parser.add_argument('--epoch', type=int, default=100, help='number of epochs to train for')
parser.add_argument('--batchSize', type=int, default=50, help='input batch size 100')
...
parser.add_argument('--num_item_negatives', type=int, default=50, help='the number of item negatives 100')
parser.add_argument('--num_sess_negatives', type=int, default=50, help='the number of session negatives 100')
...
def main():
    ...
    if opt.dataset == 'Cell_Phones_and_Accessories':
        n_node = 10213
    elif opt.dataset == 'Cell_Phones_and_AccessoriesSpa':
        n_node = 14534
    elif opt.dataset == 'Sports_and_Outdoors':
        n_node = 17782
    elif opt.dataset == 'Sports_and_OutdoorsSpa':
        n_node = 39012
    elif opt.dataset == 'Grocery_and_Gourmet_Food':
        n_node = 7877
    elif opt.dataset == 'Grocery_and_Gourmet_FoodSpa':
        n_node = 18499
    else:
